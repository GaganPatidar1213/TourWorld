...
<body>
    ...
    int tr=Integer.parseInt(request.getParameter("tourists"));
    int pr = tr*22999;
}
    %>
    ...
    <form action="bookdetails" method="post">
        ...
        <label for="tourists">Total Number of Tourists:</label>
         ...
         <span style="color:red;">${error1}</span> 
            ...
            <input readonly type="text" id="package" name="package" value = "Gujarat">
            
             <label for="price">Price:</label>
            <input readonly type="number" id="price" name="price" value = "21999">
             
            
            <input type="hidden" name="totalPrice" value="<%= pr %>">
