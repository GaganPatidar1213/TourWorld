<%-- 
    Document   : Booking5
    Created on : 13-May-2024, 2:05:10 pm
    Author     : dell
--%>
    ...
    <form action="bookdetails" method="post">
        ...
        <label for="tourists">Total Number of Tourists:</label>
         ...
         <span style="color:red;">${error1}</span> 
            ...
            <input readonly type="text" id="package" name="package" value = "Himachal Pradesh">
             <label for="price">Price</label>
            <input readonly type="number" id="price" name="price" value = "26999">
