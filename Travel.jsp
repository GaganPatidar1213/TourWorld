  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="index.html"><button style="border-radius:10px; border:none;  padding:10px;  background-color:#ADD8E6; ">Log Out</button></a></li>
      </ul>
    </nav>
    <header id="Home">
...
<!--          <h1>Travel</h1>-->
    ...
    <section id="Packages" class="banner__container">
     ...
     <div class="example">          
      ...
      <img class="img" src="assets/HM2.jpg" alt="tree" />
       <div class="content">
        <div class="text">
